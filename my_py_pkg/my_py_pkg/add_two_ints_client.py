...
class AddTwoIntsClient(Node):
    ...
    def call_add_two_ints(self, a, b):
        ...
        request = AddTwoInts.Request() #Call the constructor
        request.a = a
        request.b = b

        future = self.client_.call_async(request) #using just client_.call can deadlock everything if it flops
                                                  #call_async return a future (promise)
